...
class DummyData extends Seeder
{
    public function run()
    {
        ...
        DB::table('plots')->insert([
            ...
            ['building_type_id' => 1, 'plot_name' => 'PL-013'],
            ['building_type_id' => 1, 'plot_name' => 'PL-014'],
            ['building_type_id' => 1, 'plot_name' => 'PL-015'],
            ['building_type_id' => 2, 'plot_name' => 'PL-016'],
            ['building_type_id' => 2, 'plot_name' => 'PL-017'],
            ['building_type_id' => 2, 'plot_name' => 'PL-018'],
            ['building_type_id' => 2, 'plot_name' => 'PL-019'],
